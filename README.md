...
- Insert `https://github.com/vectao/com.unity.ide.antigravity.git`
- Add
- Done
...
> `com.unity.ide.cursor` to `com.vectao.ide.antigravity` to support Antigravity editor integration.
> This package provides Antigravity editor integration for Unity projects.
